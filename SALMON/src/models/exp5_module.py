...
from src.models.components.exp5_model import IntegratedResNet
...
class SalmonLitModule(LightningModule):
    ...
    # configure_optimizers 메서드 내에서
    def configure_optimizers(self):
    # 오직 backbone 모듈의 파라미터만 사용하여 옵티마이저 생성
        optimizer = AnalogAdam(self.backbone.parameters(), **self.optimizer_config)

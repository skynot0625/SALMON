...
from src.models.components.exp6_5_model import IntegratedResNet
...
class SalmonLitModule(LightningModule):
    ...
    # 모든 필요한 모듈의 파라미터를 그룹화
        ...
        # 그룹화된 파라미터를 사용하여 옵티마이저 생성
        optimizer = AnalogAdam(parameters, **self.optimizer_config)

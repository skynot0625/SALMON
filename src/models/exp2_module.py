...
#         }
    ...
    def configure_optimizers(self):
        optimizer = AnalogAdam(self.backbone.parameters(), lr=self.hparams.optimizer['lr'],
        ...
        if isinstance(self.hparams.scheduler, functools.partial):
            ...
            scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, *scheduler_args, **scheduler_kwargs)
        else:
